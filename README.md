...
* `pdftotext` -- it works as expected. I used to think that  the resulting
  output gave me tables' content column-by-column, which made understanding the
  data harder, but "-raw" flag prevents it.
